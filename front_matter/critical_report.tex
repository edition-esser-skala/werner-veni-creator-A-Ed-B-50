...
\subtitle{(A-Ed B 50)}
\scoring{S, A (solo), S, A, T, B (coro), 2 vl, b, org}
\maketitle
...
This edition bases upon a copy in the Dommusikarchiv Eisenstadt. The digital version of the manuscript is available at \url{http://dommusikarchiv.martinus.at/site/werkverzeichnis/gallery/780.html} (siglum B 50; see also RISM ID  600038022).
...
\begin{longtable}{ll L{10cm}}
  ...
  \midrule \endhead
  3  & S    & 8th sixteenth in Ms: c″16 \\
  3  & T    & 8th sixteenth in Ms: a16 \\
  8  & S    & 8th sixteenth in Ms: g′16 \\
  13 & S    & 8th sixteenth in Ms: c″16 \\
  13 & T    & 8th sixteenth in Ms: a16 \\
  93 & vl 2 & 3rd quarter in Ms: g′4 \\
  \bottomrule
\end{longtable}


This edition has been compiled and checked with utmost diligence. Nevertheless, errors and mistakes cannot be totally excluded. Please report any errors and mistakes to \url{wolfgang@esser-skala.at} or create an issue or pull request on the edition’s GitHub page \url{https://github.com/skafdasschaf/werner-veni-creator-A-Ed-B-50}. Your help will be greatly appreciated.
